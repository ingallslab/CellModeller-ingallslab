...
from Scripts.run_ss_on_exp_sim.scripts.helper_functions.helperFunctions import create_pickle_list, \
    read_time_step, load_cellStates
...
def run_population_counts_and_write_to_csv(file_dir_path, pickle_list, output_file,
                                           max_cell_type=max_cell_type_default):
    """
