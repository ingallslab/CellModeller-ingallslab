...
# Import csv
path_to_csv = r'C:\Users\aaron\OneDrive - University of Waterloo\Research\Papers\Biophysics Calibration\experimental_data\e_coli\MG1655\FOSBE_data\processed_data\Output-ImageProcessing+PostProcessing'
csv_file = 'summary_stats_150.csv'
df = pd.read_csv(os.path.join(path_to_csv, csv_file))

# Get data
data = df[['aspect_ratio', 'convexity', 'order_parameter', 'density_parameter', 'growth_rate', 'R2_exp_fit']]
...
# Label summary stats
ax.set_xticklabels(['Aspect Ratio', 'Convexity', 'Order', 'Density', 'Growth Rate', 'Exp. Fit'])
