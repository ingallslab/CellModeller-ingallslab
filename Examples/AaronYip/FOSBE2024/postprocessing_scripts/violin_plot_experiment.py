...
# Import csv
path_to_csv = r'C:\Users\aaron\OneDrive - University of Waterloo\Research\Papers\Biophysics Calibration\experimental_data\e_coli\MG1655\FOSBE_data'
csv_file = 'experimental_summary_stats.csv'
...
sns.violinplot(data=DataRS, x='variable', y='value', hue='Exp', inner='box', dodge=True, linewidth=1.5, palette='colorblind', scale='width', ax=ax, legend=False)
